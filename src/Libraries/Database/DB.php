...
use DongPHP\System\Libraries\Database\Driver\Processor;
...
class DB
{
    ...
    public function __construct()
    {
        ...
        $container->bind('db.connector.mysql_hash',  'DongPHP\System\Libraries\Database\Driver\Connector');
        $container->bind('db.connection.mysql_hash', 'DongPHP\System\Libraries\Database\Driver\Connection');
